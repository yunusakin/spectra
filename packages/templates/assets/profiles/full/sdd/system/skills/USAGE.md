...
Canonical files:
- Visual graph: `sdd/system/skills/dependency-graph.md`
- Machine-readable graph: `sdd/system/skills/dependency-map.tsv`
...
- Prompts are reusable checklists/templates. See `sdd/system/prompts/USAGE.md`.
