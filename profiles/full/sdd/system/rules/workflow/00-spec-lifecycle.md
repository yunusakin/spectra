...
## Progress Tracking (Mandatory In Consumer Repositories)
After every task that modifies files in a Spectra-managed consumer repository, update `sdd/memory-bank/core/progress.md` with:
- latest status
